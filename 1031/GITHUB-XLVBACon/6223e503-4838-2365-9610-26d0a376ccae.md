...
## Syntax
 ...
 _Ausdruck_. **SetSegmentType**( ** _Index_**, ** _SegmentType_** )
...
|:-----|:-----|:-----|:-----|
| _Index_|Erforderlich|**Long**|The node whose segment type is to be set.|
| _SegmentType_|Erforderlich|**[MsoSegmentType](http://msdn.microsoft.com/library/1a015227-8090-52a7-24f9-71d7e34fd05d%28Office.15%29.aspx)**|Specifies if the segment is straight or curved.|
