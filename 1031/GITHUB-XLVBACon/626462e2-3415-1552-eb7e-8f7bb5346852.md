...
## Syntax
 ...
 _Ausdruck_. **DollarDe**( ** _Arg1_**, ** _Arg2_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|Erforderlich|**Variant**|Fractional_dollar - is a number expressed as a fraction.|
| _Arg2_|Erforderlich|**Variant**|Fraction - the integer to use in the denominator of the fraction.|
