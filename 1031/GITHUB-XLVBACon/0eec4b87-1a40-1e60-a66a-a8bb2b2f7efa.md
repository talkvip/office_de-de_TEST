...
## Syntax
 ...
 _Ausdruck_. **BuildFreeform**( ** _EditingType_**, ** _X1_**, ** _Y1_** )
...
|:-----|:-----|:-----|:-----|
| _EditingType_|Erforderlich|**[MsoEditingType](http://msdn.microsoft.com/library/5fe5c4f6-6467-c6a7-197c-ff700c384b92%28Office.15%29.aspx)**|The editing property of the first node.|
| _X1_|Erforderlich|**Single**|The position (in points) of the first node in the freeform drawing relative to the upper-left corner of the document.|
| _Y1_|Erforderlich|**Single**|The position (in points) of the first node in the freeform drawing relative to the upper-left corner of the document.|
