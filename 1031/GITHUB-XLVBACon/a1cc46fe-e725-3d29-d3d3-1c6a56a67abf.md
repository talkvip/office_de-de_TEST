...
## Syntax
 ...
 _Ausdruck_. **Covariance_P**( ** _Arg1_**, ** _Arg2_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|Erforderlich|**Variant**|The first cell range of integers.|
| _Arg2_|Erforderlich|**Variant**|The second cell range of integers.|
