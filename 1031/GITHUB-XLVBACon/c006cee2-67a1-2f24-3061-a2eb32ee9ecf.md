...
## Syntax
 ...
 _Ausdruck_. **FillAcrossSheets**( ** _Range_**, ** _Type_** )
...
|:-----|:-----|:-----|:-----|
| _Range_|Erforderlich|**Range**|The range to fill on all the worksheets in the collection. The range must be from a worksheet within the collection.|
