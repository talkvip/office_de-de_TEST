...
## Syntax
 ...
 _Ausdruck_. **AddSet**( ** _Name_**, ** _Caption_** )
...
|:-----|:-----|:-----|:-----|
| _Name_|Erforderlich|**String**|A valid name in the SETS schema rowset.|
| _Caption_|Erforderlich|**String**|A string representing the field that will be displayed in the PivotTable view.|
