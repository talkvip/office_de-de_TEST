...
|:-----|:-----|:-----|:-----|
| _Arg1_|Erforderlich|**Variant**|Known_y's - an array or range of data points.|
| _Arg2_|Erforderlich|**Variant**|Known_x's - an array or range of data points.|
