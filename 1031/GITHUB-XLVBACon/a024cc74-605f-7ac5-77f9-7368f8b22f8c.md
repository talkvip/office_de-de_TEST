...
## Syntax
 ...
 _Ausdruck_. **DollarFr**( ** _Arg1_**, ** _Arg2_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|Erforderlich|**Variant**|Decimal_dollar - is a decimal number.|
| _Arg2_|Erforderlich|**Variant**|Fraction - the integer to use in the denominator of a fraction.|
