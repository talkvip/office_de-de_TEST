...
## Syntax
 ...
 _Ausdruck_. **PercentRank_Inc**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|Erforderlich|**Variant**|Array - The array or range of data with numeric values that defines relative standing.|
| _Arg2_|Erforderlich|**Double**|X - The value for which you want to know the rank.|
