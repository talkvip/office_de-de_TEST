...
## Syntax
 ...
 _Ausdruck_. **Add**( ** _Name_**, ** _Formula_**, ** _SolveOrder_**, ** _Type_** )
...
| _Formula_|Erforderlich|**String**|The formula of the calculated member.|
 ...
 **Hinweis**  Connection to the cube and existing pivot table is necessary for the sample to run.
