...
## Syntax
 ...
 _Ausdruck_. **Fv**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_**, ** _Arg5_** )
...
| _Arg2_|Erforderlich|**Double**|Nper - the total number of payment periods in an annuity.|
| _Arg3_|Erforderlich|**Double**|Pmt - the payment made each period; it cannot change over the life of the annuity. Typically, pmt contains principal and interest but no other fees or taxes. If pmt is omitted, you must include the pv argument.|
