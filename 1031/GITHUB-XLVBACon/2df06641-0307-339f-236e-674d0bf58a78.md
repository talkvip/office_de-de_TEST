...
## Syntax
 ...
 _Ausdruck_. **SumIf**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|Erforderlich|**Range**|Range - the range of cells that you want evaluated by criteria.|
| _Arg2_|Erforderlich|**Variant**|Criteria - the criteria in the form of a number, expression, or text that defines which cells will be added. For example, criteria can be expressed as 32, "32", ">32", or "apples".|
