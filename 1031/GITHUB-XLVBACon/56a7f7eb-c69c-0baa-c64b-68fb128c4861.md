...
## Syntax
 ...
 _Ausdruck_. **Percentile_Exc**( ** _Arg1_**, ** _Arg2_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|Erforderlich|**Variant**|Array - The array or range of data that defines relative standing.|
| _Arg2_|Erforderlich|**Double**|K - The percentile value in the range 0..1, exclusive.|
