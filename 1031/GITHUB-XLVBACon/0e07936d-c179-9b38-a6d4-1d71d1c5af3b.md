...
## Syntax
 ...
 _Ausdruck_. **ApplyLayout**( ** _Layout_**, ** _ChartType_** )
...
|:-----|:-----|:-----|:-----|
| _Layout_|Erforderlich|**Long**|Specifies the type of layout. The type of layout is denoted by a number from 1 to 10.|
