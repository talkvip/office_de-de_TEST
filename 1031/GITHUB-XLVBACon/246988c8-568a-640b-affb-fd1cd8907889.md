...
## Syntax
 ...
 _Ausdruck_. **Dollar**( ** _Arg1_**, ** _Arg2_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|Erforderlich|**Double**|Number - a number, a reference to a cell containing a number, or a formula that evaluates to a number.|
