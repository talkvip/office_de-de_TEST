...
## Syntax
 ...
 _Ausdruck_. **SearchB**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|Erforderlich|**String**|Find_text - the text you want to find.|
| _Arg2_|Erforderlich|**String**|Within_text - the text in which you want to search for find_text.|
 ...
 **Wichtig**  SEARCH is intended for use with languages that use the single-byte character set (SBCS), whereas SEARCHB is intended for use with languages that use the double-byte character set (DBCS). The default language setting on your computer affects the return value in the following way:
