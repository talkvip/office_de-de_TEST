...
## Syntax
 ...
 _Ausdruck_. **AddCalculatedMember** _(Name,_ _Formula,_ _SolveOrder,_ _Type,_ _DisplayFolder,_ _MeasureGroup,_ _ParentHierarchy,_ _ParentMember,_ _NumberFormat)_
...
|:-----|:-----|:-----|:-----|
| _Name_|Erforderlich|STRING|The name of the calculated member.|
| _Formula_|Erforderlich|VARIANT|The formula of the calculated member.|
 ...
 **Hinweis**  In both of these samples, the PivotTable must be refreshed after creating the calculation in order to view it in the user interface.
