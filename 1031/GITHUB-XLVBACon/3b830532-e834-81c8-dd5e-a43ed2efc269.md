...
## Syntax
 ...
 _Ausdruck_. **Add**( ** _PivotCache_**, ** _TableDestination_**, ** _TableName_**, ** _ReadData_**, ** _DefaultVersion_** )
...
|:-----|:-----|:-----|:-----|
| _PivotCache_|Erforderlich|**[PivotCache](c3d84ef1-f9e6-b1bc-cbf0-3ba8dfe17439.md)**|The PivotTable cache on which the new PivotTable report is based. The cache provides data for the report.|
| _TableDestination_|Erforderlich|**Variant**|The cell in the upper-left corner of the PivotTable report's destination range (the range on the worksheet where the resulting report will be placed). You must specify a destination range on the worksheet that contains the  **PivotTables** object specified by _expression_.|
