...
## Syntax
 ...
 _Ausdruck_. **PresetTextured**( ** _PresetTexture_** )
...
|:-----|:-----|:-----|:-----|
| _PresetTexture_|Erforderlich|**[MsoPresetTexture](http://msdn.microsoft.com/library/fbbc897d-f5db-eb0d-20d9-f6b7e9bbcf4f%28Office.15%29.aspx)**|The type of texture to apply.|
