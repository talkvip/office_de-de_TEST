...
## Syntax
 ...
 _Ausdruck_. **Resize**( ** _Range_** )

 _Ausdruck_ An expression that returns a **ListObject** object.
...
|:-----|:-----|:-----|:-----|
| _Range_|Erforderlich|**[Range](b8207778-0dcc-4570-1234-f130532cc8cd.md)**|The new range.|
