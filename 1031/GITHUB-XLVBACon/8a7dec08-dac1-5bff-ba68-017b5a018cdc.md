...
## Syntax
 ...
 _Ausdruck_. **CoupDayBs**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|Erforderlich|**Variant**|The security's settlement date. The security settlement date is the date after the issue date when the security is traded to the buyer.|
| _Arg2_|Erforderlich|**Variant**|The security's maturity date. The maturity date is the date when the security expires.|
| _Arg3_|Erforderlich|**Variant**|The number of coupon payments per year. For annual payments, frequency = 1; for semiannual, frequency = 2; for quarterly, frequency = 4.|
