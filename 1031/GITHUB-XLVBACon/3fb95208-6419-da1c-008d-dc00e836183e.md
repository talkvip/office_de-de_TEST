...
## Syntax
 ...
 _Ausdruck_. **Convert**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|Erforderlich|**Variant**|The value in from_units to convert.|
| _Arg2_|Erforderlich|**Variant**|The units for number.|
| _Arg3_|Erforderlich|**Variant**|The units for the result. Convert accepts the following text values (in quotation marks) for from_unit and to_unit which are listed in the Remarks section below.|
