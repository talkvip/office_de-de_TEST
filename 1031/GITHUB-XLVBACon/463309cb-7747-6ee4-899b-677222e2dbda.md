...
## Syntax
 ...
 _Ausdruck_. **FindB**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_** )
...
| _Arg2_|Erforderlich|**String**|Within_text - the text containing the text you want to find.|
 ...
 **Wichtig**  FIND is intended for use with languages that use the single-byte character set (SBCS), whereas FINDB is intended for use with languages that use the double-byte character set (DBCS). The default language setting on your computer affects the return value in the following way:
