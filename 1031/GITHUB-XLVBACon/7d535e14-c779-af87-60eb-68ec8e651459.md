...
## Syntax
 ...
 _Ausdruck_. **OnRepeat**( ** _Text_**, ** _Procedure_** )
...
|:-----|:-----|:-----|:-----|
| _Text_|Erforderlich|**String**|The text that appears with the  **Repeat** command.|
| _Procedure_|Erforderlich|**String**|The name of the procedure that will be run when you choose the  **Repeat** command.|
