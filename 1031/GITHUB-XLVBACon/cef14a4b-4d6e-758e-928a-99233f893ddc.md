...
## Syntax
 ...
 _Ausdruck_. **Distribute**( ** _DistributeCmd_**, ** _RelativeTo_** )
...
|:-----|:-----|:-----|:-----|
| _DistributeCmd_|Erforderlich|**[MsoDistributeCmd](http://msdn.microsoft.com/library/be0cb580-1d82-1443-0f03-3461ddb9c33d%28Office.15%29.aspx)**|Specifies whether shapes in the range are to be distributed horizontally or vertically.|
