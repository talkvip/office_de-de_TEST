...
## Syntax
 ...
 _Ausdruck_. **F_Dist**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_** )
...
| _Arg2_|Erforderlich|**Double**|Deg_freedom1 - The numerator degrees of freedom.|
| _Arg3_|Erforderlich|**Double**|Deg_freedom2 - The denominator degrees of freedom.|
