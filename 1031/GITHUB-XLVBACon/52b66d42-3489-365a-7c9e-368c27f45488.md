...
## Syntax
 ...
 _Ausdruck_. **TwoColorGradient**( ** _Style_**, ** _Variant_** )
...
| _Variant_|Erforderlich|**Integer**|The gradient variant. Can be a value from 1 through 4, corresponding to one of the four variants on the  **Gradient** tab in the **Fill Effects** dialog box. If _Style_ is **msoGradientFromCenter**, the _Variant_ argument can only be 1 or 2.|
