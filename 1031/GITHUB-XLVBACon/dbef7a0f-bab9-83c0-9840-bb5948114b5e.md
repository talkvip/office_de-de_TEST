...
## Syntax
 ...
 _Ausdruck_. **Permut**( ** _Arg1_**, ** _Arg2_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|Erforderlich|**Double**|Number - an integer that describes the number of objects.|
| _Arg2_|Erforderlich|**Double**|Number_chosen - an integer that describes the number of objects in each permutation.|
