...
## Syntax
 ...
 _Ausdruck_. **IfError**( ** _Arg1_**, ** _Arg2_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|Erforderlich|**Variant**|Value - the argument that is checked for an error.|
| _Arg2_|Erforderlich|**Variant**|Value_if_error - the value to return if the formula evaluates to an error. The following error types are evaluated: #N/A, #VALUE!, #REF!, #DIV/0!, #NUM!, #NAME?, or #NULL!.|
