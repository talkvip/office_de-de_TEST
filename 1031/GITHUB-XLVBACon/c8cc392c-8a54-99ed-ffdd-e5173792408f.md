...
## Syntax
 ...
 _Ausdruck_. **EndConnect**( ** _ConnectedShape_**, ** _ConnectionSite_** )
...
|:-----|:-----|:-----|:-----|
| _ConnectedShape_|Erforderlich|**[Shape](8f01fcd1-b7d9-5216-2de5-40fb6648a403.md)**|The shape to attach the end of the connector to. The specified  **Shape** object must be in the same **[Shapes](f9c6548c-d028-1b70-a11c-c4b45ff19177.md)** collection as the connector.|
| _ConnectionSite_|Erforderlich|**Long**|Must be an integer between 1 and the integer returned by the  **ConnectionSiteCount** property of the specified shape. If you want the connector to automatically find the shortest path between the two shapes it connects, specify any valid integer for this argument and then use the **[RerouteConnections](12e6a6aa-1ddb-392d-14c1-9d57de465c66.md)** method after the connector is attached to shapes at both ends.|
