...
## Syntax
 ...
 _Ausdruck_. **Prob**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|Erforderlich|**Variant**|X_range - the range of numeric values of x with which there are associated probabilities.|
| _Arg2_|Erforderlich|**Variant**|Prob_range - a set of probabilities associated with values in x_range.|
| _Arg3_|Erforderlich|**Double**|Lower_limit - the lower bound on the value for which you want a probability.|
