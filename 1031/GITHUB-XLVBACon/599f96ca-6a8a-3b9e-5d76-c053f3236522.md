...
## Syntax
 ...
 _Ausdruck_. **IncrementRotationX**( ** _Increment_** )
...
|:-----|:-----|:-----|:-----|
| _Increment_|Erforderlich|**Single**|Specifies how much (in degrees) the rotation of the shape around the x-axis is to be changed. Can be a value from ? 90 through 90. A positive value tilts the shape up; a negative value tilts it down.|
