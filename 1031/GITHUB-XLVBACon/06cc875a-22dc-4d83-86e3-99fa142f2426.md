...
# Erstellen Sie eine HTML-Datei mit einem Inhaltsverzeichnis basierend auf Zelldaten

In diesem Codebeispiel wird veranschaulicht, wie Daten aus einem Arbeitsblatt und ein Inhaltsverzeichnis in einer HTML-Datei zu erstellen. Das Arbeitsblatt sollte Daten in den Spalten A, B und C, die die erste entsprechen, zweite und dritte Ebenen der Hierarchie der Inhalt der Tabelle. Die HTML-Datei wird in der gleichen Arbeitsordner als die aktive Arbeitsmappe gespeichert.
