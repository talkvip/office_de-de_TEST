...
## Syntax
 ...
 _Ausdruck_. **T_Dist**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_** )
...
| _Arg2_|Erforderlich|**Double**|Deg_freedom - An integer that indicates the number of degrees of freedom.|
| _Arg3_|Erforderlich|**Boolean**|Cumulative - A logical value that determines the form of the function. If cumulative is TRUE, T_DIST returns the cumulative distribution function; if FALSE, it returns the probability density function.|
