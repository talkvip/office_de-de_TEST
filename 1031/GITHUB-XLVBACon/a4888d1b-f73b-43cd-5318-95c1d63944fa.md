...
## Syntax
 ...
 _Ausdruck_. **GetChartElement**( ** _x_**, ** _y_**, ** _ElementID_**, ** _Arg1_**, ** _Arg2_** )
...
|:-----|:-----|:-----|:-----|
| _x_|Erforderlich|**Long**|The X coordinate of the chart element.|
| _y_|Erforderlich|**Long**|The Y coordinate of the chart element.|
| _ElementID_|Erforderlich|**Long**|When the method returns, this argument contains the  **[XLChartItem](34a85683-2693-10b3-cdb2-e40e123071ad.md)** value of the chart element at the specified coordinates. For more information, see the ?Remarks? section.|
| _Arg1_|Erforderlich|**Long**|When the method returns, this argument contains information related to the chart element. For more information, see the ?Remarks? section.|
| _Arg2_|Erforderlich|**Long**|When the method returns, this argument contains information related to the chart element. For more information, see the ?Remarks? section.|
