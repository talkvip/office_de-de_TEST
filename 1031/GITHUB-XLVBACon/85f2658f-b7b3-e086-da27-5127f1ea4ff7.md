...
## Syntax
 ...
 _Ausdruck_. **Extend**( ** _Source_**, ** _Rowcol_**, ** _CategoryLabels_** )
...
|:-----|:-----|:-----|:-----|
| _Source_|Erforderlich|**Variant**|The new data to be added to the  **SeriesCollection** object as a **Range** object.|
