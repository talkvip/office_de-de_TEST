...
## Syntax
 ...
 _Ausdruck_. **AverageIf**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|Erforderlich|**Range**|One or more cells to average.|
| _Arg2_|Erforderlich|**Variant**|The criteria in the form of a number, expression, cell reference, or text that defines which cells are averaged. For example, criteria can be expressed as 32, "32", ">32", "apples", or B4.|
 ...
 **Hinweis**  The AverageIf method measures central tendency, which is the location of the center of a group of numbers in a statistical distribution. The three most common measures of central tendency are:
