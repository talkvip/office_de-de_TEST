...
## Syntax
 ...
 _Ausdruck_. **OddFPrice**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_**, ** _Arg5_**, ** _Arg6_**, ** _Arg7_**, ** _Arg8_**, ** _Arg9_** )
...
| _Arg3_|Erforderlich|**Variant**|Issue - the security's issue date.|
| _Arg4_|Erforderlich|**Variant**|First_coupon - the security's first coupon date.|
| _Arg5_|Erforderlich|**Variant**|Rate - the security's interest rate.|
| _Arg6_|Erforderlich|**Variant**|Yld - the security's annual yield.|
| _Arg7_|Erforderlich|**Variant**|Redemption - the security's redemption value per $100 face value.|
| _Arg8_|Erforderlich|**Variant**|Frequency - the number of coupon payments per year. For annual payments, frequency = 1; for semiannual, frequency = 2; for quarterly, frequency = 4.|
