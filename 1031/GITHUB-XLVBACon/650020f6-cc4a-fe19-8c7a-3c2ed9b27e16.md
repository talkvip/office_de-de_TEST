...
## Syntax
 ...
 _Ausdruck_. **ScrollIntoView**( ** _Left_**, ** _Top_**, ** _Width_**, ** _Height_**, ** _Start_** )
...
|:-----|:-----|:-----|:-----|
| _Left_|Erforderlich|**Long**|The horizontal position of the rectangle (in points) from the left edge of the document window or pane.|
| _Top_|Erforderlich|**Long**|The vertical position of the rectangle (in points) from the top of the document window or pane.|
| _Width_|Erforderlich|**Long**|The width of the rectangle, in points.|
| _Height_|Erforderlich|**Long**|The height of the rectangle, in points.|
