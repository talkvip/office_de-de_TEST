...
## Syntax
 ...
 _Ausdruck_. **Find**( ** _What_**, ** _After_**, ** _LookIn_**, ** _LookAt_**, ** _SearchOrder_**, ** _SearchDirection_**, ** _MatchCase_**, ** _MatchByte_**, ** _SearchFormat_** )
...
|:-----|:-----|:-----|:-----|
| _What_|Erforderlich|**Variant**|The data to search for. Can be a string or any Microsoft Excel data type.|
...
| _LookIn_|Optional|**Variant**|The type of information.|
...
| _SearchDirection_|Optional|[XlSearchDirection](fc53fda7-d01c-c407-ccdb-d12004a4dcee.md)|The search direction.|
