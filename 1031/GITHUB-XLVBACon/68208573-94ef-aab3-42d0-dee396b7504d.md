...
## Syntax
 ...
 _Ausdruck_. **Norm_Dist**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|Erforderlich|**Double**|X - The value for which you want the distribution.|
...
| _Arg4_|Erforderlich|**Boolean**|Cumulative - A logical value that determines the form of the function. If cumulative is TRUE, NORM_DIST returns the cumulative distribution function; if FALSE, it returns the probability mass function.|
