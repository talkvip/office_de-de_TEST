...
## Syntax
 ...
 _Ausdruck_. **NegBinom_Dist**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|Erforderlich|**Double**|Number_f - the number of failures.|
| _Arg2_|Erforderlich|**Double**|Number_s - the threshold number of successes.|
| _Arg3_|Erforderlich|**Double**|Probability_s - the probability of a success.|
