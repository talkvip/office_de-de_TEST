...
## Syntax
 ...
 _Ausdruck_. **Match**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|Erforderlich|**Variant**|Lookup_value - the value you use to find the value you want in a table.|
| _Arg2_|Erforderlich|**Variant**|Lookup_array - a contiguous range of cells containing possible lookup values. Lookup_array must be an array or an array reference.|
