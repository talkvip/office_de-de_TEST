...
## Syntax
 ...
 _Ausdruck_. **BeforeRefresh**( ** _Cancel_** )
...
|:-----|:-----|:-----|:-----|
| _Cancel_|Erforderlich|**Boolean**|**False** when the event occurs. If the event procedure sets this argument to **True**, the refresh doesn't occur when the procedure is finished.|
