...
## Syntax
 ...
 _Ausdruck_. **IntRate**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_**, ** _Arg5_** )
...
| _Arg3_|Erforderlich|**Variant**|Investment - the amount invested in the security.|
| _Arg4_|Erforderlich|**Variant**|Redemption - the amount to be received at maturity.|
