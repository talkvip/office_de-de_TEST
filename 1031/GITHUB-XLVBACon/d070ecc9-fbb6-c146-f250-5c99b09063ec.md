...
## Syntax
 ...
 _Ausdruck_. **FollowHyperlink**( ** _Address_**, ** _SubAddress_**, ** _NewWindow_**, ** _AddHistory_**, ** _ExtraInfo_**, ** _Method_**, ** _HeaderInfo_** )
...
|:-----|:-----|:-----|:-----|
| _Address_|Erforderlich|**String**|The address of the target document.|
