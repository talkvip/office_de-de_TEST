...
## Syntax
 ...
 _Ausdruck_. **Intercept**( ** _Arg1_**, ** _Arg2_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|Erforderlich|**Variant**|Known_y's - the dependent set of observations or data.|
| _Arg2_|Erforderlich|**Variant**|Known_x's - the independent set of observations or data.|
