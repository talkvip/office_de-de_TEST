...
## Syntax
 ...
 _Ausdruck_. **AccrIntM**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_**, ** _Arg5_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|Erforderlich|**Variant**|The security's issue date.|
| _Arg2_|Erforderlich|**Variant**|The security's maturity date.|
| _Arg3_|Erforderlich|**Variant**|The security's annual coupon rate.|
| _Arg4_|Erforderlich|**Variant**|The security's par value. If you omit par, ACCRINTM uses $1,000.|
