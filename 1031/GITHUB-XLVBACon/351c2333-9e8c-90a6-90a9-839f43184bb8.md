...
## Syntax
 ...
 _Ausdruck_. **RemoveItem**( ** _Index_**, ** _Count_** )
...
|:-----|:-----|:-----|:-----|
| _Index_|Erforderlich|**Long**|The number of the first item to be removed. Valid values are from 1 to the number of items in the list (returned by the  **ListCount** property).|
