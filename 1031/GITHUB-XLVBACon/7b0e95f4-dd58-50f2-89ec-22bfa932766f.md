...
## Syntax
 ...
 _Ausdruck_. **GammaInv**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_** )
...
| _Arg3_|Erforderlich|**Double**|Beta - a parameter to the distribution. If beta = 1, GAMMAINV returns the standard gamma distribution.|
