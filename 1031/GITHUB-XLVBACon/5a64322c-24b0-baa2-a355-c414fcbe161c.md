...
## Syntax
 ...
 _Ausdruck_. **FVSchedule**( ** _Arg1_**, ** _Arg2_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|Erforderlich|**Variant**|Principal - the present value.|
| _Arg2_|Erforderlich|**Variant**|Schedule - an array of interest rates to apply.|
