...
## Syntax
 ...
 _Ausdruck_. **BeforeRightClick**( ** _Target_**, ** _Cancel_** )
...
|:-----|:-----|:-----|:-----|
| _Target_|Erforderlich|**Range**|The cell nearest to the mouse pointer when the right-click occurs.|
| _Cancel_|Erforderlich|**Boolean**|**False** when the event occurs. If the event procedure sets this argument to **True**, the default right-click action doesn't occur when the procedure is finished.|
