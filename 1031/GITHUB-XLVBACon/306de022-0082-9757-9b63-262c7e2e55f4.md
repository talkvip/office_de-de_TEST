...
|:-----|:-----|:-----|:-----|
| _Arg1_|Erforderlich|**Variant**|Values - an array or a reference to cells that contain numbers for which you want to calculate the internal rate of return.|
