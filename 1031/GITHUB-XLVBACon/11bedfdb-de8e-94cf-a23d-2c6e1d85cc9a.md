...
## Syntax
 ...
 _Ausdruck_. **Add**( ** _Source_**, ** _Rowcol_**, ** _SeriesLabels_**, ** _CategoryLabels_**, ** _Replace_** )
...
|:-----|:-----|:-----|:-----|
| _Source_|Erforderlich|**Variant**|The new data as a  **[Range](b8207778-0dcc-4570-1234-f130532cc8cd.md)** object.|
