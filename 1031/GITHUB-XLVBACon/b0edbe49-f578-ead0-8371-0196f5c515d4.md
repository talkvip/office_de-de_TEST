...
## Syntax
 ...
 _Ausdruck_. **XmlImportXml**( ** _Data_**, ** _ImportMap_**, ** _Overwrite_**, ** _Destination_** )
...
|:-----|:-----|:-----|:-----|
| _Data_|Erforderlich|**String**|The data to import.|
| _ImportMap_|Erforderlich|**[XmlMap](39b0823f-0068-d8df-e4e1-ca62b55d58f5.md)**|The schema map to apply when importing the file.|
