# RangeFill-Objekt (JavaScript-API für Excel)
...
|:---------------|:--------|:----------|
|[clear()](#clear)|void|Setzt den Hintergrund des Bereichs zurück.|
...
In diesem Beispiel wird der Bereichshintergrund zurückgesetzt.
...
```
Im folgenden Beispiel wird die Füllfarbe festgelegt. 
