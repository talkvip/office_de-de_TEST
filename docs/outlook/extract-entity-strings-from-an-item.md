...
- Die die Anfangszeit des Besprechungsvorschlags darstellende Zeichenfolge von der [MeetingSuggestion.start](http://dev.outlook.com/reference/add-ins/simple-types.html%28Office.15%29.md)-Eigenschaft
